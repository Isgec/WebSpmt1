Partial Class GF_spmtNewDispSBD
  Inherits SIS.SYS.GridBase
  Private _InfoUrl As String = "~/SPMT_Main/App_Display/DF_spmtNewDispSBD.aspx"
  ...
  Protected Sub GVspmtNewDispSBD_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles GVspmtNewDispSBD.Init
    DataClassName = "GspmtNewDispSBD"
    SetGridView = GVspmtNewDispSBD
  End Sub
  ...
  Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
    ...
    Dim validateScriptIRNo As String = "<script type=""text/javascript"">" & _
      ...
      "    validated_FK_SPMT_newSBD_IRNo_main = true;" & _
      "    validate_FK_SPMT_newSBD_IRNo(o);" & _
      "  }" & _
      "</script>"
    ...
    End If
    Dim validateScriptFK_SPMT_newSBD_IRNo As String = "<script type=""text/javascript"">" & _
      "  function validate_FK_SPMT_newSBD_IRNo(o) {" & _
      "    var value = o.id;" & _
      "    var IRNo = $get('" & F_IRNo.ClientID & "');" & _
      "    try{" & _
      "    if(IRNo.value==''){" & _
      "      if(validated_FK_SPMT_newSBD_IRNo.main){" & _
      ...
      "    PageMethods.validate_FK_SPMT_newSBD_IRNo(value, validated_FK_SPMT_newSBD_IRNo);" & _
      "  }" & _
      "  validated_FK_SPMT_newSBD_IRNo_main = false;" & _
      "  function validated_FK_SPMT_newSBD_IRNo(result) {" & _
      ...
      "  }" & _
      "</script>"
    If Not Page.ClientScript.IsClientScriptBlockRegistered("validateFK_SPMT_newSBD_IRNo") Then
      Page.ClientScript.RegisterClientScriptBlock(GetType(System.String), "validateFK_SPMT_newSBD_IRNo", validateScriptFK_SPMT_newSBD_IRNo)
    End If
  End Sub
  <System.Web.Services.WebMethod()> _
