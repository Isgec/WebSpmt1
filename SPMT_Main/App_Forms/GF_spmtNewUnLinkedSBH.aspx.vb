Partial Class GF_spmtNewUnLinkedSBH
  Inherits SIS.SYS.GridBase
  Private _InfoUrl As String = "~/SPMT_Main/App_Display/DF_spmtNewUnLinkedSBH.aspx"
  ...
  Protected Sub GVspmtNewUnLinkedSBH_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GVspmtNewUnLinkedSBH.RowCommand
    ...
    If e.CommandName.ToLower = "Selectwf".ToLower Then
      Try
        Dim IRNo As Int32 = GVspmtNewUnLinkedSBH.DataKeys(e.CommandArgument).Values("IRNo")
        SIS.SPMT.spmtNewUnLinkedSBH.SelectWF(IRNo, "")
  ...
  Protected Sub GVspmtNewUnLinkedSBH_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles GVspmtNewUnLinkedSBH.Init
    DataClassName = "GspmtNewUnLinkedSBH"
    SetGridView = GVspmtNewUnLinkedSBH
  End Sub
  ...
  Protected Sub F_TranTypeID_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles F_TranTypeID.SelectedIndexChanged
    ...
    InitGridPage()
  End Sub
  Protected Sub F_SupplierName_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles F_SupplierName.TextChanged
    Session("F_SupplierName") = F_SupplierName.Text
    InitGridPage()
  End Sub
