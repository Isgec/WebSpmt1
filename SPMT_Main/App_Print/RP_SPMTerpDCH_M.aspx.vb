  ...
  Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    If oVar.IssuerID <> "" Then
      ...
      With Col
        ...
        .Font.Size = FontUnit.Point(11)
        .CssClass = "alignCenter"
        .Text = "GSTIN: " & oVar.FK_SPMT_erpDCH_IssuerID.Description
      End With
      Row.Cells.Add(Col)
      Tbl.Rows.Add(Row)
    End If
    ...
    oRow.Cells.Add(oCol)
    oCol = New TableCell
    If oVar.ConsignerGSTIN = "" Then
      oCol.Text = oVar.ConsignerGSTINNo
    Else
      oCol.Text = oVar.FK_SPMT_erpDCH_ConsignerGSTIN.Description
    End If
    oCol.Style.Add("text-align", "left")
    oCol.ColumnSpan = "2"
    oRow.Cells.Add(oCol)
    ...
    oRow.Cells.Add(oCol)
    oCol = New TableCell
    If oVar.ConsigneeGSTIN = "" Then
      oCol.Text = oVar.ConsigneeGSTINNo
    Else
      oCol.Text = oVar.FK_SPMT_erpDCH_ConsigneeGISTIN.Description
    End If
    oCol.Style.Add("text-align", "left")
    oCol.ColumnSpan = "2"
    oRow.Cells.Add(oCol)
    ...
    Dim ospmtDCDetailss As List(Of SIS.SPMT.SPMTerpDCD) = SIS.SPMT.SPMTerpDCD.UZ_SPMTerpDCDSelectList(0, 999, "", False, "", oVar.ChallanID)
    If ospmtDCDetailss.Count > 0 Then
      ...
      oRow.Cells.Add(oCol)
      oTbl.Rows.Add(oRow)
      For Each ospmtDCDetails As SIS.SPMT.SPMTerpDCD In ospmtDCDetailss
        oRow = New TableRow
        oCol = New TableCell
        oCol.CssClass = "rowHD"
