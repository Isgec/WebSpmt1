<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_SPMTerpDCH_M.aspx.vb" Inherits="EF_SPMTerpDCH_M" title="Edit: ERP Delivery Challan" %>
...
<ContentTemplate>
  <LGM:ToolBar0 
    ...
    UpdateAndStay = "False"
    EnablePrint = "True"
    PrintUrl = "../App_Print/RP_SPMTerpDCH_M.aspx?pk="
  ...
  <EditItemTemplate>
    ...
    <table style="margin:auto;border: solid 1pt lightgrey">
      <tr>
        ...
        <td class="alignright">
          <b><asp:Label ID="Label2" ForeColor="#CC6633" runat="server" Text="Challan Type :" /><span style="color:red">*</span></b>
        </td>
        <td>
          <asp:DropDownList
            ID="F_DCType"
