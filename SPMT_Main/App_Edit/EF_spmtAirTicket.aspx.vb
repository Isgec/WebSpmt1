Partial Class EF_spmtAirTicket
  ...
  Public Property PrimaryKey() As String
    ...
    End Set
  End Property
  Protected Sub ODSspmtAirTicket_Selected(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceStatusEventArgs) Handles ODSspmtAirTicket.Selected
    Dim tmp As SIS.SPMT.spmtAirTicket = CType(e.ReturnValue, SIS.SPMT.spmtAirTicket)
  ...
  Protected Sub FVspmtAirTicket_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles FVspmtAirTicket.PreRender
    TBLspmtAirTicket.EnableSave = Editable
    TBLspmtAirTicket.EnableDelete = Deleteable
    Dim mStr As String = ""
    Dim oTR As IO.StreamReader = New IO.StreamReader(HttpContext.Current.Server.MapPath("~/SPMT_Main/App_Edit") & "/EF_spmtAirTicket.js")
    mStr = oTR.ReadToEnd
    oTR.Close()
    oTR.Dispose()
