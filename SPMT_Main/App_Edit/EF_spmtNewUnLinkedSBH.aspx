<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_spmtNewUnLinkedSBH.aspx.vb" Inherits="EF_spmtNewUnLinkedSBH" title="Edit: *Pending Supplier Bill" %>
<asp:Content ID="CPHspmtNewUnLinkedSBH" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="ui-widget-content page">
<div id="div2" class="caption">
    <asp:Label ID="LabelspmtNewUnLinkedSBH" runat="server" Text="&nbsp;Edit: *Pending Supplier Bill"></asp:Label>
</div>
...
<ContentTemplate>
  <LGM:ToolBar0 
    ...
    runat = "server" />
<asp:FormView ID="FVspmtNewUnLinkedSBH"
  runat = "server"
  DataKeyNames = "IRNo"
  DataSourceID = "ODSspmtNewUnLinkedSBH"
...
<asp:ObjectDataSource 
  ...
  SelectMethod = "spmtNewUnLinkedSBHGetByID"
  UpdateMethod="UZ_spmtNewUnLinkedSBHUpdate"
  OldValuesParameterFormatString = "original_{0}"
