<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_spmtPaymentAdviceSupplierBill.aspx.vb" Inherits="EF_spmtPaymentAdviceSupplierBill" title="Edit: Selected Bills" %>
<asp:Content ID="CPHspmtPaymentAdviceSupplierBill" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="ui-widget-content page">
<div id="div2" class="caption">
    <asp:Label ID="LabelspmtPaymentAdviceSupplierBill" runat="server" Text="&nbsp;Edit: Selected Bills"></asp:Label>
</div>
...
<ContentTemplate>
  <LGM:ToolBar0 
    ...
    runat = "server" />
<asp:FormView ID="FVspmtPaymentAdviceSupplierBill"
  runat = "server"
  DataKeyNames = "IRNo"
  DataSourceID = "ODSspmtPaymentAdviceSupplierBill"
...
<asp:ObjectDataSource 
  ...
  SelectMethod = "spmtPaymentAdviceSupplierBillGetByID"
  UpdateMethod="UZ_spmtPaymentAdviceSupplierBillUpdate"
