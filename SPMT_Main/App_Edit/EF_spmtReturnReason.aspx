<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_spmtReturnReason.aspx.vb" Inherits="EF_spmtReturnReason" title="Edit: Return Reason" %>
<asp:Content ID="CPHspmtReturnReason" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="ui-widget-content page">
<div id="div2" class="caption">
    <asp:Label ID="LabelspmtReturnReason" runat="server" Text="&nbsp;Edit: Return Reason"></asp:Label>
</div>
...
<asp:ObjectDataSource 
  ...
  SelectMethod = "spmtReturnReasonGetByID"
  UpdateMethod="spmtReturnReasonUpdate"
  DeleteMethod="spmtReturnReasonDelete"
