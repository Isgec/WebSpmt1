<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="AF_SPMTerpDCIPending.aspx.vb" Inherits="AF_SPMTerpDCIPending" title="Add: ERP DC Balance Inventory" %>
<asp:Content ID="CPHSPMTerpDCIPending" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="ui-widget-content page">
<div id="div2" class="caption">
    <asp:Label ID="LabelSPMTerpDCIPending" runat="server" Text="&nbsp;Add: ERP DC Balance Inventory"></asp:Label>
</div>
...
<asp:FormView ID="FVSPMTerpDCIPending"
  ...
  <InsertItemTemplate>
    ...
    <asp:Label ID="L_ErrMsgSPMTerpDCIPending" runat="server" ForeColor="Red" Font-Bold="true" Text=""></asp:Label>
      ...
      <tr>
        ...
        <td>
          <asp:TextBox
            ...
            ValidationGroup = "SPMTerpDCIPending"
            onblur= "script_SPMTerpDCIPending.validate_ChallanID(this);"
            Runat="Server" />
          ...
          <AJX:AutoCompleteExtender
            ...
            OnClientItemSelected="script_SPMTerpDCIPending.ACEChallanID_Selected"
            OnClientPopulating="script_SPMTerpDCIPending.ACEChallanID_Populating"
            OnClientPopulated="script_SPMTerpDCIPending.ACEChallanID_Populated"
      ...
      <tr>
        ...
        <td>
          <asp:TextBox
            ...
            ValidationGroup = "SPMTerpDCIPending"
            onblur= "script_SPMTerpDCIPending.validate_HSNSACCode(this);"
            Runat="Server" />
          <asp:RequiredFieldValidator 
            ID = "RFVHSNSACCode"
            runat = "server"
          ...
          <AJX:AutoCompleteExtender
            ...
            FirstRowSelected="true"
            MinimumPrefixLength="1"
            OnClientItemSelected="script_SPMTerpDCIPending.ACEHSNSACCode_Selected"
            OnClientPopulating="script_SPMTerpDCIPending.ACEHSNSACCode_Populating"
            OnClientPopulated="script_SPMTerpDCIPending.ACEHSNSACCode_Populated"
            CompletionSetCount="10"
            CompletionListCssClass = "autocomplete_completionListElement"
            CompletionListItemCssClass = "autocomplete_listItem"
            CompletionListHighlightedItemCssClass = "autocomplete_highlightedListItem"
      ...
      <tr>
        ...
        <td>
          <asp:TextBox
            ...
            ValidationGroup = "SPMTerpDCIPending"
            onblur= "script_SPMTerpDCIPending.validate_ConsignerBPID(this);"
            Runat="Server" />
          <asp:RequiredFieldValidator 
            ID = "RFVConsignerBPID"
            runat = "server"
          ...
          <AJX:AutoCompleteExtender
            ...
            FirstRowSelected="true"
            MinimumPrefixLength="1"
            OnClientItemSelected="script_SPMTerpDCIPending.ACEConsignerBPID_Selected"
            OnClientPopulating="script_SPMTerpDCIPending.ACEConsignerBPID_Populating"
            OnClientPopulated="script_SPMTerpDCIPending.ACEConsignerBPID_Populated"
            CompletionSetCount="10"
            CompletionListCssClass = "autocomplete_completionListElement"
            CompletionListItemCssClass = "autocomplete_listItem"
            CompletionListHighlightedItemCssClass = "autocomplete_highlightedListItem"
      ...
      <tr>
        ...
        <td>
          <asp:TextBox
            ...
            ValidationGroup = "SPMTerpDCIPending"
            onblur= "script_SPMTerpDCIPending.validate_ConsignerGSTIN(this);"
            Runat="Server" />
          <asp:RequiredFieldValidator 
          ...
          <AJX:AutoCompleteExtender
            ...
            FirstRowSelected="true"
            MinimumPrefixLength="1"
            OnClientItemSelected="script_SPMTerpDCIPending.ACEConsignerGSTIN_Selected"
            OnClientPopulating="script_SPMTerpDCIPending.ACEConsignerGSTIN_Populating"
            OnClientPopulated="script_SPMTerpDCIPending.ACEConsignerGSTIN_Populated"
            CompletionSetCount="10"
            CompletionListCssClass = "autocomplete_completionListElement"
            CompletionListItemCssClass = "autocomplete_listItem"
            CompletionListHighlightedItemCssClass = "autocomplete_highlightedListItem"
      ...
      <tr>
        ...
        <td>
          <asp:TextBox
            ...
            ValidationGroup = "SPMTerpDCIPending"
            onblur= "script_SPMTerpDCIPending.validate_ProjectID(this);"
            Runat="Server" />
          <asp:RequiredFieldValidator 
            ID = "RFVProjectID"
            runat = "server"
          ...
          <AJX:AutoCompleteExtender
            ...
            FirstRowSelected="true"
            MinimumPrefixLength="1"
            OnClientItemSelected="script_SPMTerpDCIPending.ACEProjectID_Selected"
            OnClientPopulating="script_SPMTerpDCIPending.ACEProjectID_Populating"
            OnClientPopulated="script_SPMTerpDCIPending.ACEProjectID_Populated"
            CompletionSetCount="10"
            CompletionListCssClass = "autocomplete_completionListElement"
            CompletionListItemCssClass = "autocomplete_listItem"
            CompletionListHighlightedItemCssClass = "autocomplete_highlightedListItem"
        ...
        <td class="alignright">
          <asp:Label ID="L_QuantityUsed" runat="server" Text="QuantityUsed :" /><span style="color:red">*</span>
        </td>
        <td>
          <asp:TextBox ID="F_QuantityUsed"
            Text='<%# Bind("QuantityUsed") %>'
            Width="184px"
            CssClass = "mytxt"
            style="text-align: Right"
            ValidationGroup="SPMTerpDCIPending"
          ...
          <AJX:MaskedEditExtender 
            ...
            InputDirection="RightToLeft"
            ErrorTooltipEnabled="true"
            TargetControlID="F_QuantityUsed" />
          <AJX:MaskedEditValidator 
            ID = "MEVQuantityUsed"
            runat = "server"
            ControlToValidate = "F_QuantityUsed"
            ControlExtender = "MEEQuantityUsed"
            EmptyValueBlurredText = "<div class='errorLG'>Required!</div>"
            Display = "Dynamic"
            EnableClientScript = "true"
            ValidationGroup = "SPMTerpDCIPending"
...
<asp:ObjectDataSource 
  ...
  InsertMethod="SPMTerpDCIPendingInsert"
