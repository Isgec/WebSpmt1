<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="AF_SPMTerpDCH.aspx.vb" Inherits="AF_SPMTerpDCH" title="Add: ERP Delivery Challan" %>
<asp:Content ID="CPHSPMTerpDCH" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="ui-widget-content page">
<div id="div2" class="caption">
    <asp:Label ID="LabelSPMTerpDCH" runat="server" Text="&nbsp;Add: ERP Delivery Challan"></asp:Label>
</div>
...
<asp:UpdatePanel ID="UPNLSPMTerpDCH" runat="server" >
  ...
  <LGM:ToolBar0 
    ...
    ToolType = "lgNMAdd"
    InsertAndStay = "False"
    AfterInsertURL = "~/SPMT_Main/App_Edit/EF_SPMTerpDCH.aspx"
...
<asp:FormView ID="FVSPMTerpDCH"
  ...
  <InsertItemTemplate>
    ...
    <asp:Label ID="L_ErrMsgSPMTerpDCH" runat="server" ForeColor="Red" Font-Bold="true" Text=""></asp:Label>
...
<asp:ObjectDataSource 
  ...
  InsertMethod="UZ_SPMTerpDCHInsert"
