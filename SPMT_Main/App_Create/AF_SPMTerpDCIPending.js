...
var script_SPMTerpDCIPending = {
    ...
    validated_FK_SPMT_erpDCInventory_ProjectID: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_SPMTerpDCIPending.validated_FK_SPMT_erpDCInventory_ProjectID_main){
    ...
    validated_FK_SPMT_erpDCInventory_ChallanID: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_SPMTerpDCIPending.validated_FK_SPMT_erpDCInventory_ChallanID_main){
        var o_d = $get(p[1]+'_Display');
        try{o_d.innerHTML = p[2];}catch(ex){}
      }
      o.style.backgroundImage  = 'none';
    ...
    validated_FK_SPMT_erpDCInventory_HSNSACCode: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_SPMTerpDCIPending.validated_FK_SPMT_erpDCInventory_HSNSACCode_main){
        var o_d = $get(p[1]+'_Display');
        try{o_d.innerHTML = p[2];}catch(ex){}
      }
      o.style.backgroundImage  = 'none';
    ...
    validated_FK_SPMT_erpDCInventory_ConsignerGSTIN: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_SPMTerpDCIPending.validated_FK_SPMT_erpDCInventory_ConsignerGSTIN_main){
        var o_d = $get(p[1]+'_Display');
        try{o_d.innerHTML = p[2];}catch(ex){}
      }
      o.style.backgroundImage  = 'none';
    ...
    validated_FK_SPMT_erpDCInventory_ConsignerBPID: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_SPMTerpDCIPending.validated_FK_SPMT_erpDCInventory_ConsignerBPID_main){
        var o_d = $get(p[1]+'_Display');
        try{o_d.innerHTML = p[2];}catch(ex){}
      }
      o.style.backgroundImage  = 'none';
    ...
    validated_FK_SPMT_erpDCInventory_SerialNo: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_SPMTerpDCIPending.validated_FK_SPMT_erpDCInventory_SerialNo_main){
        var o_d = $get(p[1]+'_Display');
        try{o_d.innerHTML = p[2];}catch(ex){}
      }
      o.style.backgroundImage  = 'none';
