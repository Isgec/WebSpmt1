...
var script_SPMTerpDCDS = {
    ...
    validate_ChallanID: function(sender) {
      ...
      this.validated_FK_SPMT_erpDCDS_ChallanID_main = true;
      this.validate_FK_SPMT_erpDCDS_ChallanID(sender,Prefix);
      },
    ...
    validate_SerialNo: function(sender) {
      ...
      this.validated_FK_SPMT_erpDCDS_SerialNo_main = true;
      this.validate_FK_SPMT_erpDCDS_SerialNo(sender,Prefix);
      },
    validate_FK_SPMT_erpDCDS_SerialNo: function(o,Prefix) {
      var value = o.id;
      var ChallanID = $get(Prefix + 'ChallanID');
      if(ChallanID.value==''){
        if(this.validated_FK_SPMT_erpDCDS_SerialNo_main){
      ...
      value = value + ',' + SerialNo.value ;
        ...
        PageMethods.validate_FK_SPMT_erpDCDS_SerialNo(value, this.validated_FK_SPMT_erpDCDS_SerialNo);
      },
    validated_FK_SPMT_erpDCDS_SerialNo_main: false,
    validated_FK_SPMT_erpDCDS_SerialNo: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_SPMTerpDCDS.validated_FK_SPMT_erpDCDS_SerialNo_main){
    ...
    validate_FK_SPMT_erpDCDS_ChallanID: function(o,Prefix) {
      var value = o.id;
      var ChallanID = $get(Prefix + 'ChallanID');
      if(ChallanID.value==''){
        if(this.validated_FK_SPMT_erpDCDS_ChallanID_main){
          var o_d = $get(Prefix + 'ChallanID' + '_Display');
          try{o_d.innerHTML = '';}catch(ex){}
        }
        return true;
      ...
      value = value + ',' + ChallanID.value ;
        ...
        o.style.backgroundRepeat= 'no-repeat';
        o.style.backgroundPosition = 'right';
        PageMethods.validate_FK_SPMT_erpDCDS_ChallanID(value, this.validated_FK_SPMT_erpDCDS_ChallanID);
      },
    validated_FK_SPMT_erpDCDS_ChallanID_main: false,
    validated_FK_SPMT_erpDCDS_ChallanID: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_SPMTerpDCDS.validated_FK_SPMT_erpDCDS_ChallanID_main){
        var o_d = $get(p[1]+'_Display');
        try{o_d.innerHTML = p[2];}catch(ex){}
      }
      o.style.backgroundImage  = 'none';
