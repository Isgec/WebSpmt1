  ...
  Public Class spmtERPSupplierBill
    ...
    Public Shared Function GetERPBill(ByVal Source As SIS.SPMT.spmtSupplierBill, ByVal Target As SIS.SPMT.spmtERPSupplierBill) As SIS.SPMT.spmtERPSupplierBill
      Try
        ...
        End Try
        Try
          If Source.SupplierGSTIN = "" Then
            Target.SupplierGSTINNumber = Source.SupplierGSTINNumber
          Else
            Target.SupplierGSTINNumber = Source.VR_BPGSTIN17_Description
          End If
        Catch ex As Exception
        End Try
      Catch ex As Exception
    ...
    Public Shared Function GetUPDInERP(ByVal Rec As SIS.SPMT.spmtERPSupplierBill) As SIS.SPMT.spmtUPDInERP
      ...
      Try
        If Rec.BPID <> String.Empty Then
          ...
          ERP.t_nama = SIS.SPMT.spmtBusinessPartner.spmtBusinessPartnerGetByID(Rec.BPID).BPName
        Else
      ...
      ERP.t_assv = (Rec.AssessableValue * Rec.ConversionFactorINR)
      ERP.t_vamt = Rec.TaxAmount
      ERP.t_cess = Rec.CessRate
      ERP.t_cmnt = (Rec.CessAmount * Rec.ConversionFactorINR)
      ...
      ERP.t_iamt = (Rec.IGSTAmount * Rec.ConversionFactorINR)
      ERP.t_srat = Rec.SGSTRate
      ERP.t_samt = (Rec.SGSTAmount * Rec.ConversionFactorINR)
      ERP.t_crat = Rec.CGSTRate
      ERP.t_camt = (Rec.CGSTAmount * Rec.ConversionFactorINR)
