...
Namespace SIS.SPMT
  ...
  Partial Public Class spmtDCHeader
    ...
    Private _SPMT_DCHeader20_Purpose As String = ""
    ...
    Private _FK_SPMT_DCHeader_ReceivedBy As SIS.COM.comUsers = Nothing
    Private _FK_SPMT_DCHeader_ClosedBy As SIS.COM.comUsers = Nothing
    Private _FK_SPMT_DCHeader_LinkedChallanID As SIS.SPMT.spmtDCHeader = Nothing
    Private _FK_SPMT_DCHeader_DestinationStateID As SIS.SPMT.spmtERPStates = Nothing
    Private _FK_SPMT_DCHeader_DestinationIsgecID As SIS.SPMT.spmtIsgecGSTIN = Nothing
    Private _FK_SPMT_DCHeader_DestinationGSTIN As SIS.SPMT.spmtBPGSTIN = Nothing
    Private _FK_SPMT_DCHeader_DestinationBPID As SIS.SPMT.spmtBusinessPartner = Nothing
    ...
    Public Property aspnet_Users19_UserFullName() As String
      ...
      End Set
    End Property
    Public Property SPMT_DCHeader20_Purpose() As String
      Get
        Return _SPMT_DCHeader20_Purpose
      End Get
      Set(ByVal value As String)
        If Convert.IsDBNull(value) Then
          _SPMT_DCHeader20_Purpose = ""
        Else
          _SPMT_DCHeader20_Purpose = value
        End If
      End Set
    End Property
    ...
    Public ReadOnly Property FK_SPMT_DCHeader_ConsigneeBPID() As SIS.SPMT.spmtBusinessPartner
      ...
      End Get
    End Property
    Public ReadOnly Property FK_SPMT_DCHeader_ReceivedBy() As SIS.COM.comUsers
      Get
        If _FK_SPMT_DCHeader_ReceivedBy Is Nothing Then
          _FK_SPMT_DCHeader_ReceivedBy = SIS.COM.comUsers.comUsersGetByID(_ReceivedBy)
        End If
        Return _FK_SPMT_DCHeader_ReceivedBy
      End Get
    End Property
    Public ReadOnly Property FK_SPMT_DCHeader_ClosedBy() As SIS.COM.comUsers
      Get
        If _FK_SPMT_DCHeader_ClosedBy Is Nothing Then
          _FK_SPMT_DCHeader_ClosedBy = SIS.COM.comUsers.comUsersGetByID(_ClosedBy)
        End If
        Return _FK_SPMT_DCHeader_ClosedBy
      End Get
    End Property
    Public ReadOnly Property FK_SPMT_DCHeader_LinkedChallanID() As SIS.SPMT.spmtDCHeader
      Get
        If _FK_SPMT_DCHeader_LinkedChallanID Is Nothing Then
          _FK_SPMT_DCHeader_LinkedChallanID = SIS.SPMT.spmtDCHeader.spmtDCHeaderGetByID(_LinkedChallanID)
        End If
        Return _FK_SPMT_DCHeader_LinkedChallanID
      End Get
    End Property
    Public ReadOnly Property FK_SPMT_DCHeader_DestinationStateID() As SIS.SPMT.spmtERPStates
      Get
        If _FK_SPMT_DCHeader_DestinationStateID Is Nothing Then
          _FK_SPMT_DCHeader_DestinationStateID = SIS.SPMT.spmtERPStates.spmtERPStatesGetByID(_DestinationStateID)
        End If
        Return _FK_SPMT_DCHeader_DestinationStateID
      End Get
    End Property
    Public ReadOnly Property FK_SPMT_DCHeader_DestinationIsgecID() As SIS.SPMT.spmtIsgecGSTIN
      Get
        If _FK_SPMT_DCHeader_DestinationIsgecID Is Nothing Then
          _FK_SPMT_DCHeader_DestinationIsgecID = SIS.SPMT.spmtIsgecGSTIN.spmtIsgecGSTINGetByID(_DestinationIsgecID)
        End If
        Return _FK_SPMT_DCHeader_DestinationIsgecID
      End Get
    End Property
    Public ReadOnly Property FK_SPMT_DCHeader_DestinationGSTIN() As SIS.SPMT.spmtBPGSTIN
      Get
        If _FK_SPMT_DCHeader_DestinationGSTIN Is Nothing Then
          _FK_SPMT_DCHeader_DestinationGSTIN = SIS.SPMT.spmtBPGSTIN.spmtBPGSTINGetByID(_DestinationBPID, _DestinationGSTIN)
        End If
        Return _FK_SPMT_DCHeader_DestinationGSTIN
      End Get
    End Property
    Public ReadOnly Property FK_SPMT_DCHeader_DestinationBPID() As SIS.SPMT.spmtBusinessPartner
      Get
        If _FK_SPMT_DCHeader_DestinationBPID Is Nothing Then
          _FK_SPMT_DCHeader_DestinationBPID = SIS.SPMT.spmtBusinessPartner.spmtBusinessPartnerGetByID(_DestinationBPID)
        End If
        Return _FK_SPMT_DCHeader_DestinationBPID
      End Get
    End Property
